...
export const DRILL_SEEDS: Drill[] = [
  ...
  },
  {
    ...
    instructions:
      'Pick a 30-yard wide landing zone. Hit 15 drives. Track how many land in zone. Aim for 10/15 (67%). Reset mental target each shot.',
  },
  {
    id: 'drive-04',
    ...
    instructions:
      'Hit 5 balls each at low, medium, and high tee heights. Notice ball flight changes. Identify which height produces your most consistent contact.',
  },
  {
    id: 'drive-05',
  ...
  // ─── Irons ────────────────────────────────────────────────────────────────
  {
    ...
    programSlugs: ['break100', 'break90', 'break80'],
    instructions:
      'Place towel or impact bag just behind ball position. Hit 15 iron shots ensuring no contact with towel. Promotes ball-first contact. Move down one club if struggling.',
  },
  {
    id: 'iron-02',
    ...
    programSlugs: ['break100', 'break90'],
    instructions:
      'Pick a target at 100 yards. Hit 10 shots with your 7-iron. Track how many land within 20 yards of target. Focus on solid contact before worrying about distance control.',
  },
  {
    id: 'iron-03',
  ...
  },
  {
    ...
    programSlugs: ['break100'],
    instructions:
      'Swing to hip height only (half backswing, half follow-through). Hit 10 balls. Goal is pure contact and center of the face. Full swings after: carry the same feeling.',
  },
  ...
  },
  {
    ...
    programSlugs: ['break100', 'break90', 'break80'],
    instructions:
      'Place 8 balls in a circle 3 feet from the hole. Make all 8 without missing. If you miss, restart. Once you clear 3 feet, move to 4 feet. Track your longest streak.',
  },
  {
    id: 'putt-03',
    ...
    programSlugs: ['break100', 'break90'],
    instructions:
      'From 30, 40, and 50 feet, hit 5 putts each. Goal: stop the ball within 3 feet of the cup (a circle of tees). Track percentage. Focus on pace and end result, not aiming for the hole.',
  },
  {
    id: 'putt-04',
    ...
    programSlugs: ['break90', 'break80'],
    instructions:
      'Choose 5 putts with visible break (10–20 feet). Before each putt: walk behind ball, pick an aim point, commit, putt. After each, assess whether aim point was right. Builds pre-shot routine and green reading.',
  },
  {
    id: 'putt-05',
    ...
    programSlugs: ['break80'],
    instructions:
      'Putt 10 balls from 5 feet using your lead hand only. Then 10 with trail hand only. Then normal. Isolates stroke mechanics and face control. Compare feel across all three.',
  },
  ...
  // ─── Course Management ─────────────────────────────────────────────────────
  {
    ...
    programSlugs: ['break100', 'break90', 'break80'],
    instructions:
      'On the range, simulate a 9-hole round. For each "hole," pick a realistic target (not maximum distance). Give yourself a 1-stroke penalty any time your simulated shot goes out of bounds. Focus on keeping ball in play over hitting it far.',
  },
  {
    id: 'mgmt-02',
  ...
  },
  {
    ...
    programSlugs: ['break90', 'break80'],
    instructions:
      'For each of 8 range targets, identify where a miss is "safe" vs "dead." Aim toward the safe miss side. Track whether you can intentionally miss the right way 6/8 times. Teaches strategic shot-shaping mindset.',
  },
  {
    id: 'mgmt-04',
    ...
    programSlugs: ['break80'],
    instructions:
      'Spend 20 minutes hitting shots only from 100 yards and in. These are your "scoring opportunities." Practice different lies, angles, and trajectories. Track attempts vs. results within 10 feet.',
  },
  {
    id: 'mgmt-05',
